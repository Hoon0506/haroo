            ...
            <path
				...
				<ul
					...
					<li class="nav-item dropdown"><a
						...
						id="dropdown01" data-bs-toggle="dropdown" aria-expanded="false">오피스홈</a>
	...
	<div class="haroo-body">
		...
		<div class="p-3 container-sm">
			...
			<form action="insertReplyAction.do" method="post">
				...
				댓글작성자:<%=employeeVO.getEm_name()%><input type="hidden" name="name"
					value="<%=employeeVO.getEm_name()%>"><br> 댓글 내용 : <input
					type="text" name="reContents"><br> <input
					type="submit" value="댓글쓰기">
			</form>
			<a href="listAction.do" class="btn btn-primary float-end">목록</a>
			<c:if test="${employeeVO.em_name == board.writer}">
				<a href="updateForm.do?bdNo=${board.bdNo}"
					class="btn btn-warning float-end">글수정</a>
				<a href="deleteAction.do?bdNo=${board.bdNo}"
