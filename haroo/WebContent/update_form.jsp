			...
			<div calss="container">
				<div class="row">
					<form action="updateAction.do" method="post">
						...
						제목 : <input type="text"
							name="title" class="form-control" maxlength="50" value="${board.title}"><br> 내용 : <br>
						<textarea name="contents" class="form-control"
								maxlength="500" placeholder="글 내용" style="height: 350px;">${board.contents}</textarea>
						<input type="submit" class="btn btn-primary float-end" value="수정완료">
					</form>
				</div>
			</div>
		</div>
