...
<main class="form-signin">
    <form action="/haroo/mypage/update-information" method="post">
        ...
        <h1 class="h3 mb-3 fw-normal"><%=employeeVO.getEm_name()%>님의 마이페이지</h1>
        <input type="hidden" name="em_no" value="${employeeVO.getEm_no()}">

        <div class="form-floating">
            사원번호 : <%=employeeVO.getEm_no()%>
        </div>
        <div class="form-floating">
            직책번호 : <%=employeeVO.getPo_no()%>
        </div>
        <div class="form-floating">
            부서번호 : <%=employeeVO.getDe_no()%>
        </div>
        <div class="form-floating">
            사원이름 : <%=employeeVO.getEm_name()%>
        </div>
        <div class="form-floating">
            내선전화 : <%=employeeVO.getEm_ext()%>
        </div>
        <div class="form-floating">
            입사일 : <%=employeeVO.getEm_first()%>
        </div>

        <div class="form-floating">
            <input type="text" class="form-control" id="floatingPhone" placeholder="${employeeVO.getEm_phone()}" name="em_phone" value="${employeeVO.getEm_phone()}">
            <label for="floatingPhone">휴대 전화</label>
        </div>
        <div class="form-floating">
            <input type="email" class="form-control" id="floatingEmail" placeholder="${employeeVO.getEm_email()}" name="em_email" value="${employeeVO.getEm_email()}">
            <label for="floatingEmail">이메일</label>
        </div>
        <div class="form-floating">
            <input type="password" class="form-control" id="floatingPassword" placeholder="${employeeVO.getEm_pw()}" name="em_pw" value="${employeeVO.getEm_pw()}">
