            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdown01">
                    ...
                    <li><a class="dropdown-item" href="/haroo/board/listAction.do">설문조사</a></li>
...
<nav>
	...
	<div class="haroo-body">
        ...
        <a href="/haroo/attendance/status" class="d-flex align-items-center pb-3 mb-3 link-dark text-decoration-none border-bottom">
            ...
            <li class="mb-1">
                ...
                <div class="collapse" id="home-collapse" style="">
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li><a href="/haroo/attendance/status" class="link-dark rounded">근태현황</a></li>
                    </ul>
                </div>
            </li>
            <li class="mb-1">
                ...
                <div class="collapse" id="dashboard-collapse" style="">
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                        <li><a href="list" class="link-dark rounded">휴가현황</a></li>
                    </ul>
                </div>
            </li>
