...
public class EmployeeVO implements Serializable {
    private int em_no;//?Ç¨?õê Î≤àÌò∏
    private int po_no;//ÏßÅÏ±Ö Î≤àÌò∏
    private int de_no;//Î∂??Ñú Î≤àÌò∏
    private String em_name;//?Ç¨?õê?ù¥Î¶?
    private String em_ext;//?Ç¥?Ñ† ?†Ñ?ôî
    private String em_phone;//?ú¥?? ?†Ñ?ôî
    private String em_email;//?ù¥Î©îÏùº
    private String em_first;//?ûÖ?Ç¨?ùº
    private String em_last;//?á¥?Ç¨?ùº
    private int au_no;//Í∂åÌïú Î≤àÌò∏
    private String em_pw;//ÎπÑÎ?Î≤àÌò∏
