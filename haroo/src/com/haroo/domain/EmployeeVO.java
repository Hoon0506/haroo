...
public class EmployeeVO implements Serializable {
	...
	public EmployeeVO(int em_no, int po_no, int de_no, String em_name, String em_ext, String em_phone, String em_email,
			String em_first, String em_last, int au_no, String em_pw) {
		this.em_no = em_no;
		this.po_no = po_no;
		this.de_no = de_no;
